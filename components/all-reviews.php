        ...
        <li class='list-group-item d-flex justify-content-between align-items-center'>
          ...
          <div class='d-flex'>
            ...
            <?php if ($current_user == $user_id) { ?>
              <!-- Bezugnahme auf Design-Elemente von [Bootstrap 5.2.3]. -->
              <a href="#" class="edit-button btn btn-success mr-2" name='edit-button' data-bs-toggle="modal" data-bs-target="#edit-comment-modal" data-comment-id="<?php echo $comment_id; ?>" data-movie-id="<?php echo $movie_id; ?>" data-comment-text="<?php echo $comment; ?>" data-user-name="<?php echo $user_name; ?>" data-created-at="<?php echo $created_at; ?>">

                <!-- Bezugnahme auf Design-Elemente von [Font Awesome 5.15.3]. -->
                <i class='fa-sharp fa-solid fa-pen'></i>
              </a>
              <!-- Bezugnahme auf Design-Elemente von [Bootstrap 5.2.3]. -->
              <button type='submit' name='delete' class='btn btn-danger delete-button ml-2' id='delete-button' onclick="return confirm('Are you sure you want to delete this comment?');"><i class='fa-sharp fa-solid fa-trash'></i></button>
            <?php  } ?>
          </div>
        </li>
        <hr>
